...
def get_response_dict():
    ...
    bot_texts[2][1] = Reply(bot_id=2, response_id=1, texts={modes.GENERAL:[["I see how that can be stressful.", "I want you to take a couple minutes and think about at least one positive aspect about your situation."], ["I\'m sorry.", "I want you to try something.", "Take a couple minutes and think about at least one positive aspect about your situation."]]}, next_id=2)
