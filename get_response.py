...
def get_response_dict():
    ...
    questions_at_end = [["Do you think {bot_name} helps you to reduce stress? Almost no help, neutral or very helpful?"]]
    ...
    bot_texts[0][0] = Reply(bot_id=0, response_id=0, texts=tmp_text, next_id=1)
    del tmp_text
    ...
    bot_texts[0][8] = Reply(bot_id=0, response_id=8, texts={modes.GENERAL:[["Cool, looks like you have a plan B.", "Just remember, even though you cannot control everything, there is a way to get back on your feet."]]}, next_id=config.QUESTION_INDEX)
    ...
    bot_texts[0][10] = Reply(bot_id=0, response_id=10, texts={modes.GENERAL:[["I\'m sorry, I didn\'t quite catch that, could you rephrase that?"]]}, next_id= [(('5','6','7', 'five', 'six','seven', '8','9','10', 'eight', 'nine', 'ten', 'likely', 'certain'), 3), (('1','2','3','4','one','two','three','four', 'unlikely', 'impossible'), 4), ((config.DEFAULT_OTHERS, ), 10)])
    ...
    bot_texts[1][0] = Reply(bot_id=1, response_id=0, texts=tmp_text, next_id=1)
    del tmp_text
    ...
    bot_texts[1][3] = Reply(bot_id=1, response_id=3, texts={modes.GENERAL:[["Seems this is not a problem worth worrying about.", " Do you still want to work on it?"], ["In that case, do you feel you\'d still like to spend time working on it?"]]}, next_id=[(config.DEFAULT_NO, config.QUESTION_INDEX), (config.DEFAULT_OTHERS, 4)])
    ...
    bot_texts[1][11] = Reply(bot_id=1, response_id=11, texts={modes.GENERAL:[["Could you adapt or reuse this strategy to solve the current problem?"], ["Could applying this strategy to the current problem lead to a desirable outcome?"]]}, next_id=[(config.DEFAULT_NO, 6), (config.DEFAULT_OTHERS, 12)])
    bot_texts[1][12] = Reply(bot_id=1, response_id=12, texts={modes.GENERAL:[["Great! Is there anything holding you back from applying this?"]]}, next_id=[(config.DEFAULT_YES, 6), (config.DEFAULT_OTHERS, 13)])
    bot_texts[1][13] = Reply(bot_id=1, response_id=13, texts={modes.GENERAL:[["Awesome! When can you do this in the next few days? I find it helpful, to add plans to my calendar."]]}, next_id=config.QUESTION_INDEX)


    bot_texts[1][6] = Reply(bot_id=1, response_id=6, texts={modes.GENERAL:[["Perhaps breaking down the problem would be helpful", "Could you describe for me a piece of the problem and a simple solution for it?"]]}, next_id=[(config.DEFAULT_NO, 8), (config.DEFAULT_OTHERS, 9)])
    ...
    bot_texts[1][9] = Reply(bot_id=1, response_id=9, texts={modes.GENERAL:[["Great, I\'m glad you can do something about it.", "By breaking down a problem into tiny steps, we can often string together a solution. Hope it helps you."]]}, next_id=config.QUESTION_INDEX)
    ...
    # tmp_text[topics.DRIVER] = [["Yeah, there are a lot of aggressive drivers on the road.", "Can you give me more detail why it\'s stressing you out?"]]
    # tmp_text[topics.VEHICLE] = [["Can you give me more details on how your vehicle isn\'t responding?"]]
    bot_texts[2][0] = Reply(bot_id=2, response_id=0, texts=tmp_text, next_id=1)
    del tmp_text

    bot_texts[2][1] = Reply(bot_id=2, response_id=1, texts={modes.GENERAL:[["I see how that can be stressful.", "I want you to take a couple minutes and think about at least one positive aspect about your situation.", "Just think about it and let me know when you are done."], ["I\'m sorry.", "I want you to try something.", "Take a couple minutes and think about at least one positive aspect about your situation.", "Just think about it and let me know when you are done."]]}, next_id=2)
    ...
    bot_texts[2][5] = Reply(bot_id=2, response_id=5, texts={modes.GENERAL:[["Positive thinking can be a good way to destress, making it easier to face challenges."], ["When you\'re feeling down about a situation, trying to find the positives can make it easier to handle."]]}, next_id=config.QUESTION_INDEX)
    ...
    #---------------------------------------------------------------------------------------------------------------------------------
    ## Humor bot
    bot_texts[3][0] = Reply(bot_id=3, response_id=0, texts={modes.GENERAL:[["Ok, tell me more detail about this situation."]]}, next_id=1)
    ...
    bot_texts[3][6] = Reply(bot_id=3, response_id=6, texts={modes.GENERAL:[["That\'s ok, humor isn\'t always the answer.", "Just remember that trying to find something funny about your situation can help lighten the mood when you're stressed.", "Sound good?"]]}, next_id=config.QUESTION_INDEX)


    #---------------------------------------------------------------------------------------------------------------------------------
    ## relaxation bot
    bot_texts[4][0] = Reply(bot_id=4, response_id=0, texts={modes.GENERAL:[["Ok, tell me more detail about this situation."]]}, next_id=1)
    ...
    bot_texts[4][14] = Reply(bot_id=4, response_id=14, texts={modes.GENERAL:[["That\'s ok. There are many other ways to deal with stress."]]}, next_id=config.QUESTION_INDEX)
    #---------------------------------------------------------------------------------------------------------------------------------
    ## self-love bot

    bot_texts[5][0] = Reply(bot_id=5, response_id=0, texts={modes.GENERAL:[["Oh, sorry to hear that. Could you give me more information about {problem}?"]]}, next_id=2)
    ...
    bot_texts[5][8] = Reply(bot_id=5, response_id=8, texts={modes.GENERAL:[["Awesome, friends can often provide the best support", "It\'s great that you have made time to prioritize yourself!"]]}, next_id=config.QUESTION_INDEX)
    ...
    bot_texts[6][2] = Reply(bot_id=6, response_id=2, texts={modes.GENERAL:[["How often do you get to do it?"], ["Tell me more! I want to hear all about it!"]]}, next_id=3)
    bot_texts[6][3] = Reply(bot_id=6, response_id=3, texts={modes.GENERAL:[["Do you have another event that you are excited about?"], ["Would you like to do this activity with another event?"]]}, next_id=[(config.DEFAULT_NO, 4), (config.DEFAULT_OTHERS, 2)])
    bot_texts[6][4] = Reply(bot_id=6, response_id=4, texts={modes.GENERAL:[["That's fine. When you're feeling stressed, it can be good to think about other things that you might be excited about."],["Snazzy. Next time you feel stressed, you could think about something that makes you excited."],["Dope! Sometimes if you are feeling stressed, it can be helpful to disengage from the current events and shift your attention to things that you are looking forward to."]]}, next_id=config.QUESTION_INDEX)
    ...
    bot_texts[8][2] = Reply(bot_id=8, response_id=2, texts={modes.GENERAL:[["Awesome, let\'s get started. Has this problem been affecting your sleep?"]]}, next_id=[(config.DEFAULT_NO, 3), (config.DEFAULT_OTHERS, 4)])
    ...
    #no - good food =1
    #{0, 1}
    bot_texts[8][7] = Reply(bot_id=8, response_id=7, texts={modes.GENERAL:[["I\'m glad to hear that.","One last question. Have you tried discussing this issue with your friends or family? They\'re the ones who often can help in a time like this."]]}, next_id=[(config.DEFAULT_NO, 14), (config.DEFAULT_OTHERS, 13)])
    #yes - bad food =0
    #{0, 0}
    ...
    #good food = 3
    #{1, 1, 1}
    bot_texts[8][9] = Reply(bot_id=8, response_id=9, texts={modes.GENERAL:[["I\'m glad that you have been able to talk with friends and/or family about this.","Wonderful, it seems as though this problem isn\'t affecting these three major aspects of your life. Great job staying on top of your sleeping and eating as well as reaching out to friends and family for support."]]}, next_id=config.QUESTION_INDEX)

    #{sleep, eat, friends}
    #{1, 1, 0}
    bot_texts[8][10] = Reply(bot_id=8, response_id=10, texts={modes.GENERAL:[["I\'m sorry to hear that. Me and my bot-friends are always here to support you. ","Hey! Good job! It seems you\'ve got things mostly under control. It might be helpful to set aside some time reaching out to people you care about"]]}, next_id=config.QUESTION_INDEX)
    
    #{1, 0, 1}
    bot_texts[8][11] = Reply(bot_id=8, response_id=11, texts={modes.GENERAL:[["I\'m glad that you have been able to talk with friends and/or family about this.", "Hey! Good job! It seems you\'ve got things mostly under control. It might be helpful to set aside some time for eating"]]}, next_id=config.QUESTION_INDEX)
    
    #{1, 0, 0}
    bot_texts[8][12] = Reply(bot_id=8, response_id=12, texts={modes.GENERAL:[["I\'m sorry to hear that. Me and my bot-friends are always here to support you. ","Great job on sleeping regularly! It could be helpful to focus on eating regularly and reaching out to people you care about."]]}, next_id=config.QUESTION_INDEX)
    
    #{0, 1, 1}
    bot_texts[8][13] = Reply(bot_id=8, response_id=13, texts={modes.GENERAL:[["I\'m glad that you have been able to talk with friends and/or family about this.","Hey! Good job! It seems you\'ve got things mostly under control. It might be helpful to set aside some time for sleeping."]]}, next_id=config.QUESTION_INDEX)
    
    #{0, 1, 0}
    bot_texts[8][14] = Reply(bot_id=8, response_id=14, texts={modes.GENERAL:[["I\'m sorry to hear that. Me and my bot-friends are always here to support you. ","Great job on eating regularly! It might be helpful to focus on sleeping regularly and reaching out to people who care about you."]]}, next_id=config.QUESTION_INDEX)

    #{0, 0, 1}
    bot_texts[8][15] = Reply(bot_id=8, response_id=15, texts={modes.GENERAL:[["I\'m glad that you have been able to talk with friends and/or family about this.","Great job on reaching out to people who care about you! It could be helfpul to focus on sleeping regularly and eating regularly."]]}, next_id=config.QUESTION_INDEX)
